from stripe_rest import customer_api, product_api, price_api, subscription_api, subscription_item_api
...
print("Created Customer Id : " + str(customer_cid))
customer = customer_api.get_customer(customer_cid)
customer_cid_2 = customer['id']
assert customer_cid == customer_cid_2, "Customer Ids do not match : {} / {}".format(customer_cid, customer_cid_2)
...
assert found, "Could not find matching customer for customer id {}".format(customer_cid)
...
assert payment_method_cid == method_cid_2, "PaymentMethod Ids do not match : {} / {}".format(payment_method_cid,
                                                                                             method_cid_2)
...
customer_cid_2 = customer['id']
assert customer_cid == customer_cid_2, "Customer Ids do not match for Update : {} / {}".format(customer_cid,
                                                                                               customer_cid_2)
...
product2 = product_api.get_product(product_cid)
print("Product Id : " + str(product2['id']))
product_cid_2 = product2['id']
assert product_cid == product_cid_2, "Product Ids do not match : {} / {}".format(product_cid, product_cid_2)
...
assert found, "Could not find matching product for product id {}".format(product_cid)
...
# assert subscription_cid.startswith("sub_"), "Create Subscription returned unexpected subscription id {}".format(
#     subscription_cid)
#
...
# assert subscription_cid == subscription_cid_2, "Subscription Ids do not match : {} / {}".format(subscription_cid,
#                                                                                                 subscription_cid_2)
#
...
# assert subscription_item_cid.startswith(
#     "subscription_item"), "Create Subscription Item returned unexpected subscription_item id {}".format(
#     subscription_item_cid)
#
...
# assert subscription_item_cid == subscription_item_cid_2, "Customer Ids do not match : {} / {}".format(
#     subscription_item_cid, subscription_item_cid_2)
#
...
assert subscription_schedule_cid == subscription_schedule_cid_2, "Customer Ids do not match : {} / {}".format(
    subscription_schedule_cid, subscription_schedule_cid_2)

subscription_schedules = subscription_schedule_api.list_subscription_schedules(customer_cid)
found = False
...
assert found, "Could not find matching subscription_schedule for subscription_schedule id {}".format(
    subscription_schedule_cid)
